...
import com.example.mytraveldiary.MyAlbumAdapter;
...
public class AccountData {
    ...
    private static final String PREFERENCES_NAME = "AccountData";
    ...
    public static  ArrayList loadArr(Context context, String key){
        ...
        Type type = new TypeToken<ArrayList<Account>>(){}.getType();//test
    ...
    //모든 키값 가져오기
    public static String allKey(Context context){
        ...
        while (it.hasNext()){//값이 나올때 까지 판단하여 while 문을 돈다
            i++;
            msg += (String) it.next()+"/";
        }
        return msg;
    ...
    //키 값 없이 모든 저장값 가져오기
    public static String allValue(Context context){
